...
db.products.insertMany([
  {
    ...
    price: 8.99,
    image: "https://omazon-server.onrender.com/pictures/products/frisbee.webp",
    description:
  ...
  },
  {
    ...
    price: 599.99,
    image: "https://omazon-server.onrender.com/pictures/products/litiere.webp",
    description:
  ...
  },
  {
    ...
    price: 6.29,
    image:
      "https://omazon-server.onrender.com/pictures/products/sacs-caca.webp",
    description:
  ...
  },
  {
    ...
    price: 22.49,
    image: "https://omazon-server.onrender.com/pictures/products/barbe.webp",
    description:
  ...
  },
  {
    ...
    price: 9.11,
    image: "https://omazon-server.onrender.com/pictures/products/vernis.webp",
    description:
  ...
  },
  {
    ...
    price: 51.64,
    image:
      "https://omazon-server.onrender.com/pictures/products/maquillage.webp",
  ...
  },
  {
    ...
    price: 3.59,
    image: "https://omazon-server.onrender.com/pictures/products/glue.webp",
    description:
  ...
  },
  {
    ...
    price: 16.97,
    image:
      "https://omazon-server.onrender.com/pictures/products/multimetre.webp",
    description:
  ...
  },
  {
    ...
    price: 24.9,
    image: "https://omazon-server.onrender.com/pictures/products/scie.webp",
    description:
  ...
  },
  {
    ...
    price: 146.0,
    image:
      "https://omazon-server.onrender.com/pictures/products/scie-sauteuse.webp",
    description:
  ...
  },
  {
    ...
    price: 28.78,
    image:
      "https://omazon-server.onrender.com/pictures/products/tournevis.webp",
    description:
  ...
  },
  {
    ...
    price: 59.57,
    image: "https://omazon-server.onrender.com/pictures/products/vans.webp",
    description: "<p><em>Pas de description pour le moment</em></p>",
    categoryId: 4,
    tagId: 2,
  },
  {
    ...
    price: 18.99,
    image:
      "https://omazon-server.onrender.com/pictures/products/chaussons.webp",
    description:
  ...
  },
  {
    ...
    price: 138.9,
    image: "https://omazon-server.onrender.com/pictures/products/sportiva.webp",
    description:
  ...
  },
  {
    ...
    price: 71.95,
    image: "https://omazon-server.onrender.com/pictures/products/dc-shoes.webp",
    description:
  ...
  },
  {
    ...
    price: 64.95,
    image:
      "https://omazon-server.onrender.com/pictures/products/espadrilles.webp",
    description:
      "<p>Faites une déclaration de style cette saison avec les chaussures Tommy Hilfiger. Notre collection de chaussures luxueuses comprend des designs tendance : des bottes à lacets pour toutes les occasions aux baskets décontractées pour un look sportif et des escarpins pour femme pour ajouter une touche glamour à votre tenue de soirée. Découvrez également nos chaussures en cuir de qualité supérieure, nos mocassins en cuir élégants et nos chaussures basses classiques. Nos bottines et bottines ou talons hauts peuvent être parfaitement combinées avec un jean skinny. Nos chaussures plates noires classiques sont la touche finale idéale à n'importe quel look de bureau.</p>",
    categoryId: 4,
    tagId: 1,
  },
  {
    ...
    price: 70.95,
    image: "https://omazon-server.onrender.com/pictures/products/bbq.webp",
    description:
      "<p>Ajoutez un goût unique à vos préparations avec le Barbecue à Charbon Weber Compact Kettle 47cm et son couvercle pensé pour contenir la chaleur, rehausser les saveurs et éviter les embrasements. Le barbecue classic kettle a été inventé par le fondateur de Weber lui-même et est utilisé à travers le monde entier: c'est l'essence même du barbecue. Ce barbecue élégant dispose d'une vasque et d'un couvercle en porcelaine émaillée qui permettent une température constante pendant la cuisson, et qui font face au mauvais temps et à la rouille. L'accroche couvercle pratique vous permet de ranger le couvercle principal sur le côté afin de pouvoir cuisiner les mains libres. Doté d'une poignée intégrée à protection thermique, ce barbecue est facile à utiliser et vous protège efficacement contre les risques de chaleur extrême. Facile à nettoyer, avec sa coupelle cendrier anti-rouille en aluminium située juste en dessous de la vasque principale et entre les trois pieds du barbecue afin de ne laisser échapper aucune cendre. Il est également simple à déplacer partout chez vous grâce à son design intelligent sur roues. Ce magnifique barbecue Kettle Weber s'utilise avec des charbons de bois ou briquettes pour un goût grillé authentique.</p>",
    categoryId: 5,
    tagId: 2,
  },
  {
    ...
    price: 29.99,
    image: "https://omazon-server.onrender.com/pictures/products/bbq-kit.webp",
    description:
      "<p><strong>Kit professionnel d'ustensiles de barbecue</strong>Comprend tous les accessoires nécessaires pour réaliser un barbecue de qualité. Pinces pour barbecue, spatule, fourchette, thermomètre à viande, brosse de nettoyage, brosses à huile, griffes à viande, brochettes de maïs, poivrier, salière et sac en tissu personnalisé portable.</p>",
    categoryId: 5,
    tagId: 0,
  },
  {
    title:
      "Kärcher Nettoyeur Haute Pression K 2 Universal Edition, Pression : max. 110 bar, Débit : 360 l/h, Surface : 20 m²/h, Filtre à Eau, Poids : 3,8 kg, Flexible et Pistolet Haute Pression, Rotabuse",
    price: 63.95,
    image: "https://omazon-server.onrender.com/pictures/products/karcher.webp",
    description:
      "<p>Le Kärcher K 2 Universal Edition est un nettoyeur haute pression pour les salissures légères et les utilisations occasionnelles. Il nettoie par exemple les outils de jardin, les meubles de balcon et les vélos. La rotabuse est adaptée aux saletés tenaces, comme les endroits moussus ou altérés par les intempéries. Il se range et se transporte facilement. Les accessoires tels que le pistolet haute pression ou le câble se rangent directement sur l'appareil.</p>",
    categoryId: 5,
    tagId: 0,
  },
  {
    title:
      "BLACK+DECKER Tondeuse Filaire 1000W, Tondeuse à Gazon Electrique 32 cm, 3 hauteurs réglables 20, 40 et 60 mm, Tondeuse Légère avec Poignée type Landau, idéale Jusqu'à 300 m², BEMW351-QS",
    price: 69.99,
    image: "https://omazon-server.onrender.com/pictures/products/tondeuse.webp",
    description:
      "<p>Grâce au puissant moteur de 1000 W et à son bac de ramassage d'une capacité de 35 litres, cette tondeuse à gazon bénéficie d'une grande polyvalence et d'une grande facilité de manœuvre et permet d'énormes économies de temps et d'efforts. Les roues dentelées garantissent une adhérence optimale et favorisent le contrôle sur tous les terrains, la poignée inclinable permet un gain de place mais en même temps une excellente maniabilité.</p>",
    categoryId: 5,
    tagId: 0,
  },
  {
    title: "BTFL Cody Surfskate 2024 Skateboard, Longboard",
    price: 208.89,
    image:
      "https://omazon-server.onrender.com/pictures/products/surfskate.webp",
    description:
      "<p>Skateboard, Longboard oder Surfskate - Warum nicht einfach alles in einem Mit Cody hast du viele Möglichkeiten, dich vorwärts zu bewegen. Wegen der bewährten G-Truck Achse ist dieses Board eigentlich als Surfskate konzipiert, lässt sich aufgrund der Deckform aber auch easy im Park, im Pool oder in der Bowl fahren. Das Tail und die breite Nose erlauben es dir, Ollies zu machen oder dich nach einem 180 Slide einfach wieder in Position zu bringen. Das starke Concave verhindert ein Wegrutschen der Füße bei engen Turns. Wenn dir die Surfskate Achse von G-Truck dafür zu weich ist, dann kannst du sie einfach härter anziehen, um mehr Stabilität beim Fahren zu erhalten. Cody ist die ideale Begleitung für all diejenigen, die sowohl Spaß am Surfskaten als auch am Skateboarden haben.</p><p>Eigenschaften:</p></ul><li>- Deckgröße: 23 x 80 cm / 9? x 31.5</li><li>- Konstruktion: 7 Lagen kanadischer Ahor</li><li>- Achsen: G-Truck Surfskat- Bushings: 78A</li><li>- Rollen: 65 x 47 mm, 80A</li></ul></p>",
    categoryId: 6,
    tagId: 0,
  },
  {
    title:
      "LEGO Star Wars Millennium Falcon, Set pour Adultes du 25e Anniversaire, Vaisseau Spatial à Collectionner, Décoration d'Intérieure, Véhicule Mythique, Cadeau d’Anniversaire pour Fans de la Saga 75375",
    price: 69.99,
    image: "https://omazon-server.onrender.com/pictures/products/lego.webp",
    description:
      "<p><strong>Description du produit</strong></p><p>La saga Star Wars s’invite dans votre salon avec ce set LEGO Star Wars Millennium Falcon (75375) à construire, à collectionner et à exposer. Concentrez-vous comme un Jedi pour recréer les détails du vaisseau mythique de Star Wars : Un nouvel espoir. Exposez votre création à l’oblique sur le support à construire pour afficher le Millenium Falcon en position de combat. Ajoutez l’écriteau et une brique LEGO Star Wars spéciale 25e anniversaire pour créer un objet décoratif qui vous rappellera de bons souvenirs.</p><p>Ce véhicule mythique Star Wars à construire fait partie d’une collection de vaisseaux LEGO Star Wars de taille moyenne. Faites-vous plaisir ou offrez ce set de construction créatif pour adultes à d’autres fans de la saga Star Wars ou à des collectionneurs.</p><p>Ce set LEGO Star Wars pour adultes propose un défi de construction créative complexe. Vous pouvez télécharger l’appli LEGO Builder pour zoomer et faire pivoter vos modèles en 3D, suivre votre progression et sauvegarder vos sets au même endroit.</p><p>Mesure plus de 13 cm de haut, 24 cm de long et 19 cm de large.</p><p>Contient 921 pièces.</p><p><strong>Avertissement De Sûreté</strong></p><p>Attention ! Danger d’étouffement. Petits éléments. Ne convient pas aux enfants de moins de 36 mois</p>",
    categoryId: 6,
    tagId: 0,
  },
  {
    title: "Wdk Partner- QUILLES Nordiques, WP-021C, Multicolore, Small",
    price: 14.5,
    image: "https://omazon-server.onrender.com/pictures/products/molki.webp",
    description:
      "<p><strong>Description du produit</strong></p><p>Ce jeu de plein air, jeu de lancer populaire combine adresse, tactique et chance et s'apparente à la fois aux jeux de pétanque, de billard et de bowling.</p><p><strong>Avertissement De Sûreté</strong></p><p>Réservé à un usage familial</p>",
    categoryId: 6,
    tagId: 0,
  },
  {
    title:
      "Nerf Elite 2.0, Blaster motorisé Double Punch, canons alternatifs Rapides, 50 fléchettes Nerf Elite, 2 chargeurs 10 fléchettes, dès 8 Ans",
    price: 19.99,
    image: "https://omazon-server.onrender.com/pictures/products/nerf.webp",
    description:
      "<p><strong>Description du produit</strong></p><p>On peut s'amuser deux fois plus grâce au blaster Double Punch Nerf Elite 2.0 avec deux canons et deux chargeurs ! Le blaster à fléchettes Double Punch a 2 canons alternatifs qui se déplacent d'avant en arrière rapidement quand on tire Ce blaster Nerf automatique inclut 2 chargeurs d'une capacité de 10 fléchettes chacun permettant de tirer 20 fléchettes de suite. Le blaster inclut 50 fléchettes en mousse Nerf Elite 2.0, ce qui permet de remplir les deux chargeurs deux fois et de garder des fléchettes en réserve. Ce blaster Nerf motorisé a des canons alternatifs qui se déplacent d'avant en arrière quand on s'amuse à tirer des fléchettes en mousse. Avec ses caractéristiques et son style amusants, le blaster Double Punch est un super cadeau pour les enfants. Les blasters Nerf électriques sont parmi les meilleurs jouets d'intérieur et d'extérieur pour inciter filles et garçons à dépenser leur énergie en jouant activement. Lunettes recommandées (non incluses). Requiert 4 piles alcalines AA de 1,5 V (non incluses) Nerf et toutes les marques associées sont des marques de commerce de Hasbro.</p><p><strong>Avertissement De Sûreté</strong></p><p>À partir de 13 ans Pour 2 à 4 joueurs.</p>",
    categoryId: 6,
    tagId: 0,
  },
  {
    title:
      "ZENAGAME Le Traquenard, Le Jeu Alcool de 300 Cartes Fun et Hilarantes pour tes Soirées Posées ou Endiablées - Jeux de Société, Jeu Adulte",
    price: 19.99,
    image:
      "https://omazon-server.onrender.com/pictures/products/traquenard.webp",
    description:
      '<ul><li>300 CARTES VARIEES ET TOUJOURS DROLES - Notre savant mélange de cartes originales vous fera oublier les jeux de société adulte où on pose des cartes sans saveur pour tirer des rires forcés à des convives génés : avec le jeu alcool et jeu apero entre amis "Le Traquenard", vos soirées seront rythmées par des votes, des actions, des tu préfères, des surprises et surtout des rires sincères et gutturaux à chaque carte jouée !</li><li>SIMPLISSIME DE JOUER, MÊME DANS UN ÉTAT ALTERNATIF - Le Traquenard est un jeu carte adulte que même le plus "malin" de tes copains (tu vois très bien de qui je parle) saura comprendre : tire une carte, lis la et exécute. Et oui, même Jean Kévin devrait arriver à jouer à ce jeu societe adulte.</li><li>POUR UNE SOIREE MEMORABLE. OU PAS - « Allez, juste un petit verre… » on connait tous ces soirées qui commencent par cette phrase magique/maudite et qui finissent le lendemain matin, avec peu de souvenirs : ce sont souvent nos meilleures soirées ! Le jeu soiree alcool et jeu d alcool "Le Traquenard" a été pensé pour vous aider à en passer plus régulièrement. Tout simplement.</li><li>ENTRE POTES ADULTES : DE 3 A 8 JOUEURS - Que vous soyez en préchauffe intimiste ou en bonne grosse soirée, une petite partie de jeux apero, jeux apéro, jeux adulte, jeux d alcool ou jeu de soiree s saura vous faire passer à un niveau supérieur de folie</li><li>DE 15 MIN A... DEMAIN MATIN - Le jeu evjf, jeu de carte adulte et jeu société adulte est pensé pour vous faire kiffer sur des parties courtes comme sur des longues soirées : Une chose est sûre, ce jeu de société adulte sera bien.</li></ul>',
    categoryId: 6,
    tagId: 0,
  },
  {
    title: "Stellar Blade, Édition Standard, PlayStation 5",
    price: 60.9,
    image: "https://omazon-server.onrender.com/pictures/products/blade.webp",
    description:
      "<p>L’avenir de l’humanité repose sur le fil d’une épée Ravagée par d'étranges et puissantes créatures, la Terre a été abandonnée, et les derniers survivants ont fui dans une colonie spatiale. Membre du 7ème escadron aéroporté, EVE quitte la colonie et retourne sur les vestiges de la planète avec une mission précise : sauver l’humanité et reprendre la Terre des griffes des NA:tifs, les créatures malveillantes qui l’ont détruite. Cependant, tandis qu’elle découvre les mystères du passé de ce monde en ruine, rien ne semble se passer comme prévu…</p>",
    categoryId: 7,
    tagId: 0,
  },
  {
    title:
      "Sony, Manette sans fil DualSense™, PlayStation 5, Batterie rechargeable, Bluetooth, Compatible PS5 et PC, couleur midnight black noire",
    price: 64.0,
    image: "https://omazon-server.onrender.com/pictures/products/manette.webp",
    description:
      "<p><strong>Description du produit</strong></p><p>Vivez une expérience de jeu incroyablement immersive grâce à la nouvelle manette pour PS5 de Sony, dotée du retour haptique et de gâchettes adaptatives. La manette sans fil DualSense comprend également un microphone intégré et la touche CREATE. Pour vous offrir une expérience de jeu aussi réaliste que possible, cette manette est dotée d'un niveau de confort et d'ergonomie optimal : vous oublierez même qu'elle est entre vos mains !</p><p><strong>Omazon.fr</strong></p><p>Manette sans Fil DualSense Black</p>",
    categoryId: 7,
    tagId: 1,
  },
  {
    title: "Nintendo Console Switch avec Joy-Con bleu néon et rouge néon",
    price: 266.09,
    image: "https://omazon-server.onrender.com/pictures/products/switch.webp",
    description:
      "<p>Console Nintendo Switch + 1 manette Joy-Con droite rouge néon + 1 manette Joy-Con gauche bleu néon + 1 support Joy-Con + 1 station d'accueil Nintendo Switch + 1 câble HDMI + 1 adaptateur secteur Nintendo Switch + 1 paire de dragonnes Joy-Con</p>",
    categoryId: 7,
    tagId: 0,
  },
  {
    ...
    price: 51.49,
    image:
      "https://omazon-server.onrender.com/pictures/products/zelda-totk.webp",
    description:
      "<p>Faites le grand saut : la suite de l’aventure en monde ouvert acclamée par la critique vous attend .</p>",
    categoryId: 7,
    tagId: 0,
  },
  {
    title: "Voice Content and Usability (English Edition)",
    price: 25.12,
    image:
      "https://omazon-server.onrender.com/pictures/products/accessibilite.webp",
    description:
      "<p>Preston So (he/they) is a digital architect and strategist, designer and developer advocate, and polyglot educator and speaker. He is the author of Immersive Content and Usability (A Book Apart, 2023), Gatsby: The Definitive Guide (O'Reilly, 2021), Voice Content and Usability (A Book Apart, 2021), and Decoupled Drupal in Practice (Apress, 2018).A globally recognized authority on the intersections of content, design, and code, Preston has been a product, design, engineering, and innovation leader since 2015 at organizations like Oracle, Acquia, Time Inc., and Gatsby. Preston is an editor at A List Apart, columnist at CMSWire, and contributor to Smashing Magazine, and has delivered keynotes around the world in three languages. He is based in New York City, where he can often be found immersing himself in languages that are endangered or underserved.</p>",
    categoryId: 8,
    tagId: 0,
  },
  {
    ...
    price: 32.9,
    image: "https://omazon-server.onrender.com/pictures/products/h2g2.webp",
    description:
      "<p><strong>Quatrième de couverture</strong></p><p>Comment garder tout son flegme quand on apprend dans la même journée : que sa maison va être abattue dans la minute pour laisser place à une déviation d'autoroute ; que la Terre va être détruite d'ici deux minutes, se trouvant, coïncidence malheureuse, sur le tracé d'une future voie express intergalactique ; que son meilleur ami, certes délicieusement décalé, est en fait un astrostoppeur natif de Bételgeuse et s'apprête à vous entraîner aux confins de la galaxie ? Pas de panique ! Car Arthur Dent, un Anglais extraordinairement moyen, pourra compter sur le fabuleux Guide du voyageur galactique pour l'accompagner dans ses extraordinaires dérapages spatiaux moyennement contrôlés. Avant d'être la série de SF humoristique la plus vendue au monde, H2G2 était un feuilleton radiophonique, douze épisodes de trente minutes, diffusé à la BBC en 1978 et 1980.</p><p><strong>Biographie de l'auteur</strong></p><p>Douglas Adams est né à Cambridge en 1952. Après ses études, il devient auteur pour la radio et la télévision, mais aussi acteur (avec les Monty Python) et réalisateur. Entres autres métiers, il a été brancardier, charpentier, vendeur de poulaillers, gorille et producteur. Il est mort en Californie en 2001, à l'âge de quarante-neuf ans.</p>",
    categoryId: 8,
    tagId: 0,
  },
  {
    ...
    price: 55.77,
    image: "https://omazon-server.onrender.com/pictures/products/react.webp",
    description:
