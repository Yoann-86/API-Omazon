...
db.user.insert({
  ...
  password:
    "66448941e331c2a4f39104f439876b616b2cbe3d34d04981513336c7d05aa84a04032dd732e741d088c39dda4d3581761f542fc90272f36be210fd32f0aa8ba2.07dcdfbaef20fabae5fa42d55f206b79",
});

db.cart.insert({
  owner: "dave.lopper@mail.com",
  products: [
    {
      _id: ObjectId("67013b6fb0bd9421cd599992"),
      id: 17,
      title: "Weber Barbecue à Charbon Compact Kettle 47cm",
      price: 70.95,
      image: "bbq",
      description:
        "<p>Ajoutez un goût unique à vos préparations avec le Barbecue à Charbon Weber...</p>",
      categoryId: 5,
      tagId: 2,
    },
  ],
